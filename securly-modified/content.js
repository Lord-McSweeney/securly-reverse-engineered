...
window.youtubeLastCheck = null, window.addEventListener ? window.addEventListener("load", callWindowLoadWithTimeOut, false) : window.attachEvent && window.attachEvent("onload", callWindowLoadWithTimeOut);
