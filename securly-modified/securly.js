...
function fetchUserAPI() {
    chrome.identity.getProfileUserInfo(function(e) {
        var t = e.email;
        true === forceUserEmail && (t = DEBUG_userEmail), "" !== t ? (window.userEmail = t, window.userFound = window.userStatus.FOUND, fetchClusterUrl()) : (window.clusterFound = window.clusterStatus.AVOID_OS, window.clusterUrl = "AVOID_OS")
    })
}

function skipCacheAndLogAlways(e, t) {
    return e.includes("twitter.com") ? 1 : e.includes("facebook.com") ? 1 : e.includes("google.co") && !e.includes("mail.google.co") && !e.includes("drive.google.co") ? 1 : -1 != e.indexOf("bing.co") ? 1 : -1 != e.indexOf("search.yahoo.co") ? 1 : -1 != e.indexOf("wikipedia.org") ? 1 : -1 != e.indexOf("youtube.co") ? 1 : 0
}
    ...
    return new Promise(function(n, o) {
        chrome.tabs.get(e, function(e) {
            if (e && "loading" == e.status) {
                ...
                if (undefined !== e.pendingUrl && ((o = new URL(e.pendingUrl).hostname).includes("securly.com") || o.includes("iheobagjkfklnlikgihanlhcddjoihkg"))) {
                    n(true);
                    return undefined;
                }
            }
...
function interceptOrNot(e) {
    ...
    var c = ENCRYPT(s);
    if (null !== localStorage.getItem(c)) return window.featureConfig.isAwareOnly ? 0 : (takeDenyActionTabs("G", "BL", "", window.btoa(s), e.tabId), t = 0);
    ...
    if (!o.includes("youtube.com") && (o = o.toLowerCase()), r.includes("google.co") && -1 != i.indexOf("/maps/") && -1 != i.indexOf("/place/")) return t = 1;
...
function takeDenyActionTabs(e, t, n, o, r, i, s) {
    invalidateSkipListCaching(o, false), clearWebCache(o), window.brokredRequest = [];
...
function takeDenyAction(e, t, n) {
    invalidateSkipListCaching(b64url, false), clearWebCache(n);
...
function getPauseAction(e) {
    return invalidateSkipListCaching(e, true), clearWebCache(e), window.brokredRequest = [], "unknown" == window.clusterUrl ? {
        cancel: true
    } : {
...
function takeToFailedOpenBlockedPage(e, t, n) {
    var o = btoa(t);
    r = [], 0 != (n & 8) && r.push("Pornography"), 0 != (Math.pow(2, 4) & n) && r.push("Drugs"), 0 != (Math.pow(2, 5) & n) && r.push("Gambling");
    var r = btoa(r.join(", "));
...
function getVersion(e) { // Get Securly for Chromebooks version by looking into the manifest file
...
function rebrokerLoadedTabs(e) {
    e = undefined === e ? "" : e, chrome.tabs.query({}, function(t) {
        for (var n = 0; n < t.length; n++) t[n].id != e && -1 == t[n].url.indexOf("securly.com") && (-1 == t[n].url.indexOf("http://") && -1 == t[n].url.indexOf("https://") || (t[n].initiator = "", t[n].type = "main_frame", t[n].method = "GET", t[n].tabId = t[n].id, onBeforeRequestListener(t[n], true)))
    })
}
...
function doBrokerForClassroom() {
    ...
    if (1 == e.classroom_enabled && undefined !== e.classroom_enabled) {
        if (1 == e.live_session && undefined !== e.live_session) return true;
...
function getRespArrTabs(e, t, n, o, r, i = "", s = false, a, c = null, l = false) {
    ...
    if (d) {
        ...
        if (selfClusterCheckBeforeBroker(), null != c && (w = c.channelId, h = c.videoId, g = c.category), u = window.clusterUrl + "/broker?useremail=" + window.userEmail + "&reason=crextn&host=" + e + "&url=" + t + "&msg=" + n + "&ver=" + window.version + "&cu=" + window.clusterUrl + "&uf=" + window.userFound + "&cf=" + window.clusterFound + (s ? "&subframe=1" : "") + ("" != i ? "&frameHost=" + i : "") + (null != w ? "&channelID=" + w : "") + (null != h ? "&videoID=" + h : "") + (null != g ? "&category=" + encodeURIComponent(g) : ""), window.geolocation && (u = u + "&lat=" + window.geoLat + "&lng=" + window.geoLng), l && (u += "&rebroker=1"), 0 == s) {
            if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) var f = createNonBlockingRequest("get", u)
        } else {
            let t = false;
        ...
        if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
            ...
            f.onload = function() {
                if (0 != (d = f.responseText.trim()).indexOf("FAILED_OPEN:")) {
                    ...
                    if (undefined !== l && l || setClearCacheCookie(r), wellPathWidgBg.triggerWidgetDisplay(), setClassroomCookies(), -1 == d.indexOf("DENY") && -1 == d.indexOf("PAUSE")) try {
        ...
        } else d = "ERROR:-1:-1:-1:-1:-1:-1";
        d = o.includes("google.c") && -1 == o.indexOf("sites.google.com") && -1 == o.indexOf("docs.google.com") && -1 == o.indexOf("drive.google.com") && -1 == o.indexOf("accounts.google.com") && -1 == o.indexOf("calendar.google.com") && -1 == o.indexOf("code.google.com") || -1 != o.indexOf("bing.com") || -1 != o.indexOf("search.yahoo.c") ? "SS:0:-1:-1:-1:-1:-1" : "ALLOW:0:-1:-1:-1:-1:-1"
    }
    var h = d.split(":");
...
function putURLCache(e, t, n, o) {
    -1 == e.indexOf("WL_URL") || undefined !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 ? 0 != o || undefined !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 || sessionStorage.setItem(n, e + "," + (new Date).getTime() / 1e3) : (resultURL = window.atob(t).replace(/(^\w+:|^)\/\/|(www\.)/, ""), sessionStorage.setItem(resultURL, e + "," + (new Date).getTime() / 1e3))
}
    ...
    chrome.tabs.onUpdated.addListener(function(e, t, n) {
        if (undefined !== t.status && -1 != n.url.indexOf("blocked")) {
            if ("complete" != t.status) {
                -1 == n.url.indexOf("blocked") || -1 == n.url.indexOf("securly.com") && -1 == n.url.indexOf("iheobagjkfklnlikgihanlhcddjoihkg") || (window.tabsBeingBlocked[e] = n.url)
            } else {
    ...
    chrome.webRequest.onBeforeSendHeaders.addListener(function(e) { // Blocking sites
        ...
        if (e.requestHeaders.forEach(function(e) {
            ...
            if (1 == o) {
                ...
                if ("sub_frame" == e.type ? (l = true, window.isSubFrame = true, window.brokredRequest = []) : (window.isSubFrame = false, l = false, window.youtubeFrames = []), -1 !== n.indexOf("youtube.") && false === window.checkYouTube || -1 === n.indexOf("youtube.") || e.initiator !== window.refDomain) var u = getRespArr(s, r, "", n, c, l);
                var f = u[0],
                    h = (u[1], u[2]),
                    w = (u[3], u[4]),
                    g = u[4];
                ...
                return this.iframeResp.length > 0 && "DENY" == this.iframeResp[0] ? (this.iframeResp = "", {
                    cancel: true
                }) : (-1 !== n.indexOf("youtube.") && "REFWL" == h ? (window.refDomain = e.initiator, window.checkYouTube = false) : -1 !== n.indexOf("youtube.") && (window.checkYouTube = true), "GM" == f ? (e.requestHeaders.push({
                    name: "X-GoogApps-Allowed-Domains",
                    value: g
                }), {
                    requestHeaders: e.requestHeaders
        ...
        "search_engine_parser" == e.name ? e.onMessage.addListener(function(t, n) {
            if ("fetchResult" == t.action && window.selfharmlist.length > 0) e.postMessage(window.selfharmlist); // Selfharmlist is a list of phone numbers for suicide prevention
...
function onBeforeRequestListener(e, t = false) {
    ...
    if (1 != r) {
        ...
        if (o.indexOf("youtube")) {
            window.ytURL = o;
            if ("UNKNOWN_SCHOOL" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && (null == window.ytOptionsLastCheck || Math.floor(Date.now() / 1e3) - window.ytOptionsLastCheck >= 3600)) {
                getYTOptions()
            }
                        ...
                        if (window.checkYouTube && o.indexOf("youtube") && "GET" == e.method && "getYoutubeOptions" != n.action && "script" !== e.type && "stylesheet" !== e.type && "image" !== e.type) {
                            ...
                            if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl && -1 === window.youtubeFrames.indexOf(t.sender.frameId) && (null != n.channelId || null != n.videoId || null != n.category)) {
                                ...
                                let c = getRespArrTabs(l, a, d, r.sender.url, r.sender.tab.id, u, n.embedded, this, o),
                                    ...
                                    f = c[1];
                                c[2];
                                "DENY" == w ? 0 == n.embedded && chrome.tabs.update(r.sender.tab, takeDenyAction(f, 2, a)) : this.iframeResp.length > 0 && "DENY" == this.iframeResp[0] && (this.iframeResp = "", t.postMessage({
                ...
                if ("gmaps" == e.name) {
                    e.onMessage.addListener(function (e, t) {
                        if (e.url != window.lastMapsUrl) {
                            ...
                            n.href = e.url;
                            let r = getRespArrTabs(l = normalizeHostname(l = n.hostname.toLowerCase()), o, "", e.url, t.sender.tab.id, "", false, this),
                                i = r[0],
                                a = r[1];
                            r[2];
                            if ("DENY" == i) {
        ...
        var i = "";
        var a = false;
        (d = document.createElement("a")).href = e.initiator, i = window.btoa(d.hostname.toLowerCase()), "sub_frame" == e.type && (i = window.btoa(d.hostname.toLowerCase()), a = true, window.isSubFrame = true, window.brokredRequest = []);
        var s;
        if (o.length > 1e3 && (o = o.substring(0, 1e3)), s = getSocialPost(e, o), -1 != o.indexOf("youtube.com") && -1 != o.indexOf("youtubei/v1/search") && (o = getYoutubeSearchURL(e, o)), false === s) return;
        var l, d, u = window.btoa(o),
            c = o.replace(/^(?:https?:\/\/)?(?:www\.)?/i, "");
        if (c.endsWith("/") && (c = c.slice(0, -1)), window.brokeredArrIndex++, window.brokeredArrIndex >= 20 && (window.brokeredArrIndex = 0), -1 != window.brokredRequest.indexOf(c) && "" === s || (window.brokredRequest[window.brokeredArrIndex] = c), -1 != o.indexOf("translate.google.com") ? l = extractTranslateHostname(o) : ((d = document.createElement("a")).href = o, l = d.hostname.toLowerCase()), l = normalizeHostname(l), window.geolocation && getRemoteIPGeo(), -1 !== o.indexOf("youtube.") && false === window.checkYouTube || -1 === o.indexOf("youtube.") || e.initiator !== window.refDomain) var w = getRespArrTabs(l, u, s, o, e.tabId, i, a, this, null, t);
        var f = w[0],
            h = w[1],
            g = w[2];
        w[3], w[4], w[5], w[6];
        ...
        var m = false;
        if ("SS" == f && (ssURL = takeSafeSearchAction(l, n), false !== ssURL && (n = ssURL), m = true), "CC" == g && (ccURL = takeCreativeCommonImageSearchAction(n), false !== ccURL && (n = ccURL), m = true), -1 !== o.indexOf("youtube.") && "REFWL" == g ? (window.refDomain = e.initiator, window.checkYouTube = false) : -1 !== o.indexOf("youtube.") && (window.checkYouTube = true), true === m) {
            if (-1 !== o.indexOf("google.") && -1 !== o.indexOf("/maps/")) return;
            if (-1 !== o.indexOf("google.")) {
                if (/q=/.test(o)) {
                    if (-1 !== o.indexOf("google.") && -1 === o.indexOf("safe=active") && -1 === o.indexOf("safe=strict")) return {
                        redirectUrl: n
                    };
                    if (false === ssURL && false === ccURL) return;
                    if (-1 !== o.indexOf("google.") && -1 !== o.indexOf("tbm=isch") && -1 === o.indexOf("tbs=il:cl")) return {
                        redirectUrl: n
                    }
                }
            } else if (-1 === o.indexOf("google.com")) return {
                redirectUrl: n
            }
        }
    }
    ...
    return chrome.runtime.onMessage.addListener((e, o) => {
        ...
        "object" == typeof e && undefined !== e.action && undefined !== e.source && undefined !== o.tab.id && -1 != o.tab.id && o.tab.id && "well-path-widget" == e.source && ("ready" == e.action && n(o.tab.id), "ctaClicked" != e.action && "closed" != e.action || (function(e) {
            try {
                ...
                "ctaClicked" == e.action && (n.ctaLabel = e.label, n.ctaLink = e.link);
                ...
                for (let t = 0; t < window.vectorExpansionRules[mainHost].length; t += 1) try {
                    ...
                    if (c.test(e.url)) {
                        if ("JSON_STR" == s) {
                            ...
                            if (buff = e.requestBody.raw[0].bytes, postContent = buff2StrWithEmoji(buff), Array.isArray(i))
                            ...
                            }, e)), "reddit.com" == mainHost && i[t].includes("richtext_json") && tempText.length > 0 && (textStr = removeHTMLTags(fetchStringFromJSONObj(JSON.parse(tempText), "t")), captionStr = removeHTMLTags(fetchStringFromJSONObj(JSON.parse(tempText), "c")), tempText = textStr + " " + captionStr), l = l.length > 0 ? l + " " + tempText : tempText;
                        else l = removeHTMLTags(i.split("|").reduce((e, t) => !t.includes("!") ? e[t] : e[t.split("!")[0]][t.split("!")[1]], e));
                        l && l.trim().includes(" ") && sendSocialPostToServer(l, mainHost, r, e.url)
                    }
                } catch (e) {}
        }
    }
